      ...
      <div>
        ...
        <div class="mt-2">
          <div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-blue-600">
            <input type="text" name="title" id="username" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="click here...">
          </div>
    ...
    <input type="text" name="tags" id="tags" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-gray-300 placeholder-gray-400 focus:outline-blue-600 sm:text-sm" placeholder="e.g., Laravel, PHP, Backend">
      ...
      @enderror
       -->
          ...
          @endif
      <button type="submit" class="bg-black text-white w-20 text-center p-2 rounded hover:bg-blue-600">add</button>
  </div>
